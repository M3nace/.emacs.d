...
(setq selection-coding-system 'utf-8         ; pretty
      ...
      nsm-settings-file (concat user-emacs-directory "nsm/network-security.data")
...
- <kbd>Alt 0</kbd> supprime la frame active
- <kbd>Alt 1</kbd> supprime la frame inactive
- <kbd>Alt 2</kbd> split la frame horizontalement
- <kbd>Alt 3</kbd> split la frame verticalement
- <kbd>Alt <flèches directionnelles></kbd> navigue entre les frames
...
Je me retrouve souvent avec 3/4 buffer ouvert en même temps, sans pour autant avoir besoin
...
En tapant =button.btn.btn-default=, un coup de <kbd>C-j</kbd> et pouf (non ça fait pas des chocapics),
...
Le module intégré =css-mode= est suffisant. J'applique juste notre linter.
...
(use-package css-mode
  ...
  (css-indent-offset 2)
  :hook
  (css-mode . (lambda() (flycheck-select-checker 'css-stylelint))))
#+end_src
